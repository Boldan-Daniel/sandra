...
ActiveRecord::Schema.define(version: 20170211163458) do
  ...
  create_table "access_tokens", force: :cascade do |t|
    ...
    t.index ["token_digest", "user_id", "api_key_id"], name: "index_access_tokens_on_token_digest_and_user_id_and_api_key_id", unique: true, using: :btree
